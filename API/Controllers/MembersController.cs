...
public class MembersController(AppDbContext context) : ControllerBase
{
    ...
    public ActionResult<IReadOnlyList<AppUser>> GetMembers() //metodo para obtener todos los miembros
    //la lista contiene appuser
    //con IReadOnlyList se usa menos memoria que con List
    {
        var members = context.Users.ToList(); //obtiene todos los usuarios de la base de datos y los convierte en una lista
    ...
    [HttpGet("{id}")] //https://localhost:5000/api/members/bob-id
       public ActionResult<AppUser> GetMember(string id) {
        var member = context.Users.Find(id); //busca un usuario por su id
